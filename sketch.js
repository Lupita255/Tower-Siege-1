...
function setup() {
  ...
  ground2=new Ground(480,450,250,10);
  ground3=new Ground(850,300,250,10);
   ...
   box17=new Block(760,200,30,40);
   box18=new Block(790,200,30,40);
   box19=new Block(820,200,30,40);
   box20=new Block(850,200,30,40);
   box21=new Block(880,200,30,40);
   box22=new Block(910,200,30,40);
   box23=new Block(940,200,30,40);
   box24=new Block(790,170,30,40);
   box25=new Block(820,170,30,40);
   box26=new Block(850,170,30,40);
   box27=new Block(880,170,30,40);
   box28=new Block(910,170,30,40);
   box29=new Block(820,140,30,40);
   box30=new Block(850,140,30,40);
   box31=new Block(880,140,30,40);
   box32=new Block(850,110,30,40);

   polygon=new Polygon(180,300,20);

   attach=new chain(polygon.body,{x:180, y:300});
